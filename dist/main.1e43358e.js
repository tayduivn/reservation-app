...
var _default = {
  ...
  computed: {
    hasErrors: {
      ...
      get: function get() {
        return this.$store.state.hasErrors;
      }
    },
          ...
          _c(
            ...
            [
              _c(
                "sui-button",
                {
                  attrs: { color: "green", inverted: "", icon: "check" },
                  nativeOn: {
                    click: function($event) {
                      return _vm.clearErrors($event)
                    }
                  }
                },
                [_vm._v("\n        OK\n      ")]
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Home.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    RATIO: function RATIO() {
      return this.attendance.students / this.attendance.teachers;
    }
  },
  watch: {
    'attendance.students': function attendanceStudents() {
      if (this.attendance.students < 20) this.$store.commit('SET_ERRORS', 'We require a minimim of 20 kids for a field trip.');
    },
    'attendance.teachers': function attendanceTeachers() {
      if (this.RATIO < 10) this.$store.commit('SET_ERRORS', 'In order for teacher to have free tickets, the student to teacher ratio cannot be greater than 10 to 1.');
    }
  }
};
exports.default = _default;
      ...
      _c("div", { staticClass: "column" }, [
        _c("div", { staticClass: "ui segment" }, [
          ...
          _c("input", {
            ...
            on: {
              __r: function($event) {
                _vm.$set(_vm.attendance, "parents", _vm._n($event.target.value))
              },
              blur: function($event) {
                return _vm.$forceUpdate()
              }
...
exports.default = _default;
},{"./components/Home.vue":"src/components/Home.vue","./components/Attendance.vue":"src/components/Attendance.vue"}],"src/modules.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mutations: {
    ...
    SET_HAS_ERRORS: function SET_HAS_ERRORS(state, payload) {
      Object.assign(state, {
        hasErrors: payload
      });
    },
...
var store = new _vuex.default.Store(_modules.default);
new _vue.default({
  router: router,
  store: store,
  render: function render(h) {
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","vue-router":"node_modules/vue-router/dist/vue-router.esm.js","vuex":"node_modules/vuex/dist/vuex.esm.js","semantic-ui-vue":"node_modules/semantic-ui-vue/dist/commonjs/index.js","./App":"src/App.vue","./routes":"src/routes.js","./modules":"src/modules.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
